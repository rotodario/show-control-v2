    ...
    <x-slot name="header">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div class="flex flex-col gap-3 sm:flex-row">
                <a href="{{ route('shows.mail', $show) }}" class="inline-flex items-center justify-center rounded-full border border-sky-200 px-4 py-2.5 text-sm font-semibold text-sky-700 transition hover:bg-sky-50">
                    {{ __('ui.send_mail') }}
                </a>
