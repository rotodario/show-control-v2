        ...
        <div class="flex h-16 justify-between gap-4">
            <div class="flex min-w-0 items-center gap-6">
                <a href="{{ route('dashboard') }}" class="flex items-center gap-3">
                    ...
                    <div class="hidden sm:block">
                        <p class="text-xs font-semibold uppercase tracking-[0.3em] text-slate-500">{{ __('ui.show_control_title') }}</p>
                        <p class="text-sm font-semibold text-slate-900">{{ __('ui.tours_and_production') }}</p>
                    </div>
                </a>
            ...
            <div class="hidden items-center gap-3 sm:flex">
                <div class="text-right">
                    ...
                    <p class="text-xs text-slate-500">{{ Auth::user()->getRoleNames()->implode(', ') ?: __('ui.no_role') }}</p>
                </div>
                    ...
                    <x-slot name="content">
                        ...
                        >
                            ...
                            <span class="rounded-full px-2 py-1 text-xs font-semibold" :class="$store.theme.current === 'dark' ? 'bg-slate-900 text-white' : 'bg-slate-100 text-slate-600'">
                                <span x-text="$store.theme.current === 'dark' ? '{{ __('ui.on') }}' : '{{ __('ui.off') }}'"></span>
                            </span>
                        </button>
