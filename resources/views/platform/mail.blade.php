    ...
    <x-slot name="header">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <h2 class="text-2xl font-semibold text-slate-900">{{ __('ui.platform_mail_title') }}</h2>
            </div>
            <p class="max-w-2xl text-sm text-slate-500">
                {{ __('ui.platform_mail_description') }}
            </p>
        </div>
    </x-slot>
            ...
            <form method="POST" action="{{ route('platform.mail.update') }}" class="space-y-6">
                ...
                <section class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
                    <div class="flex items-start justify-between gap-6">
                        <div>
                            <h3 class="text-lg font-semibold text-slate-900">{{ __('ui.registration_notices') }}</h3>
                            <p class="mt-2 text-sm text-slate-500">{{ __('ui.registration_notices_help') }}</p>
                        </div>
                    ...
                    <div class="mt-6 grid gap-5 md:grid-cols-2">
                        <div>
                            <label for="platform_mail_from_name" class="text-sm font-semibold text-slate-900">{{ __('ui.sender_name') }}</label>
                        ...
                        <div>
                            <label for="platform_mail_from_address" class="text-sm font-semibold text-slate-900">{{ __('ui.sender_email') }}</label>
                        ...
                        <div>
                            <label for="platform_mail_reply_to_email" class="text-sm font-semibold text-slate-900">{{ __('ui.reply_to_email') }}</label>
                        ...
                        <div class="md:col-span-2">
                            <label for="platform_registration_recipients" class="text-sm font-semibold text-slate-900">{{ __('ui.registration_recipients') }}</label>
                ...
                <section class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
                    <h3 class="text-lg font-semibold text-slate-900">{{ __('ui.global_notice_template') }}</h3>
                    ...
                    <div class="mt-6 grid gap-5">
                        <div>
                            <label for="platform_registration_subject" class="text-sm font-semibold text-slate-900">{{ __('ui.subject') }}</label>
                        ...
                        <div>
                            <label for="platform_registration_body" class="text-sm font-semibold text-slate-900">{{ __('ui.message_body') }}</label>
