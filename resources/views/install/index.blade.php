        ...
        <div class="grid gap-6 xl:grid-cols-[0.75fr_1.25fr]">
            ...
            <section class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div class="mt-5 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-600">
                    El instalador aplicara todas las migraciones actuales, configurara el bootstrap seguro de super admin y dejara listas las funciones de bolos, accesos compartidos, alertas, chat interno, PDF, logistica de viaje, cuenta, usuarios de plataforma y herramientas de backup basadas en web.
                </div>
