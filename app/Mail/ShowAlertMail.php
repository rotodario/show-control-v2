...
class ShowAlertMail extends Mailable
{
    ...
    public function build(): static
    {
        $context = [
            ...
            'show_status' => \App\Models\Show::STATUS_OPTIONS[$this->show->status] ?? $this->show->status,
            'travel_mode' => \App\Models\Show::TRAVEL_MODE_OPTIONS[$this->show->travel_mode ?: 'van'] ?? ($this->show->travel_mode ?: '-'),
